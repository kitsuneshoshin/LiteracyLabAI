...
const CONFIDENCE_NOTE = {
  starting: "This student marked themselves as just starting out and building confidence in this skill. Open the Glow with one extra sentence of genuine, specific encouragement before anything else — not generic praise, but something tied to what they actually did.",
  growing: "This student is getting there — steady, matter-of-fact encouragement is right, no need to over-praise.",
  confident: "This student is already confident — treat them as capable of hearing direct, specific feedback without extra cushioning.",
};
...
function buildReadingPrompt({ tier, country, gradeLabel, interest, confidenceReading, passageTitle, passage, questions, answers, score, totalQuestions }) {
